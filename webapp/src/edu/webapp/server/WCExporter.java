...
public class WCExporter
{
	...
	public static void saveCloudAsHTML(String filename, WordCloud cloud, WCSetting setting)
	{
		...
		try
		{
			...
			writer.write("<object data=\"../svgs/" + filename + ".svg\" type=\"image/svg+xml\" height=" + cloud.getHeight() + "px; width=" + cloud.getWidth() + "px></object>");
			writer.write("<div style=\"width=100px\">" + setting.toString() + "</div>");
			writer.write("<div style=\"float: right\">Share The Cloud!<a href=\"https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwordcloud.cs.arizona.edu%2Fhtmlforclouds%2F" + filename
