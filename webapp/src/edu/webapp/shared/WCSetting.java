...
public class WCSetting implements Serializable
{
    ...
    {
        RANDOM, WORD_RANK, KMEANS, SENTIMENT
    }

    public enum COLOR_SCHEME
    {
        GREEN, ORANGE, BLUE, BREWER_1, BREWER_2, BREWER_3, SIMILAR_1, SIMILAR_2, SIMILAR_3, TRISCHEME_1, TRISCHEME_2, TRISCHEME_3, BEAR_DOWN, SENTIMENT, SENTIMENT2
    }
