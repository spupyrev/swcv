...
public class UniformAreaMetric implements QualityMetric
{
    ...
    private double computeUsedAreaOfCell(SWCRectangle cell, List<Word> words, LayoutResult algo)
    {
        double res = 0;
        for (Word w : words)
        {
    ...
    private double computeWordsInsideCell(SWCRectangle cell, List<Word> words, LayoutResult algo)
    {
        double res = 0;
        for (Word w : words)
        {
