...
public class ruStemmer extends SnowballStemmer {

private static final long serialVersionUID = 1L;

        private final static ruStemmer methodObject = new ruStemmer ();
        ...
        private int I_pV;
                ...
                private void copy_from(ruStemmer other) {
                    I_p2 = other.I_p2;
                    I_pV = other.I_pV;
        ...
        public boolean equals( Object o ) {
            return o instanceof ruStemmer;
        }

        public int hashCode() {
            return ruStemmer.class.getName().hashCode();
        }
