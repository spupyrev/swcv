 ...
 * May 3, 2013
 */
public class BoundingBoxPackingPlacer implements WordPlacer
{
    ...
    public BoundingBoxPackingPlacer(List<Word> words, List<? extends LayoutAlgo> singlePlacers, double weightToAreaFactor, BoundingBoxGenerator bbGenerator)
    {
        this.words = words;
